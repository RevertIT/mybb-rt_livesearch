...
final class Frontend
{
    ...
    public function misc_start(): void
    {
        ...
        if ($mybb->get_input('action') === Core::get_plugin_info('prefix'))
        {
            ...
            $plugin_info = Core::$PLUGIN_DETAILS;
     ...
     * @return void
     */
    public function search_do_search_start(): void
    {
        global $mybb;
     ...
     * @return void
     */
    public function search_do_search_process(): void
    {
     ...
     * @return void
     */
    public function search_do_search_end(): void
    {
     ...
     * @return void
     */
    public function search_results_thread(): void
    {
